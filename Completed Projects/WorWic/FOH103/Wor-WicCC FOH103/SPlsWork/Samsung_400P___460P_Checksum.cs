...
namespace CrestronModule_SAMSUNG_400P___460P_CHECKSUM
{
    public class CrestronModuleClass_SAMSUNG_400P___460P_CHECKSUM : SplusObject
    {
        ...
        object FROM_SMPL__DOLLAR___OnChange_0 ( Object __EventInfo__ )
            ...
            try
            {
                ...
                if ( Functions.TestForTrue  ( ( Functions.BoolToInt (_SplusNVRAM.SEMAPHORE == 0))  ) ) 
                    ...
                    if ( Functions.TestForTrue  ( ( Functions.BoolToInt ( Functions.Find( "\u00AA" , FROM_SMPL__DOLLAR__ ) > 0 ))  ) ) 
                        { 
                        __context__.SourceCodeLine = 75;
                        _SplusNVRAM.ILENGTH = (ushort) ( Functions.Length( FROM_SMPL__DOLLAR__ ) ) ; 
                        __context__.SourceCodeLine = 76;
                        _SplusNVRAM.TEMP__DOLLAR__  .UpdateValue ( Functions.Mid ( FROM_SMPL__DOLLAR__ ,  (int) ( 2 ) ,  (int) ( (_SplusNVRAM.ILENGTH - 1) ) )  ) ; 
    ...
    public CrestronModuleClass_SAMSUNG_400P___460P_CHECKSUM ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
