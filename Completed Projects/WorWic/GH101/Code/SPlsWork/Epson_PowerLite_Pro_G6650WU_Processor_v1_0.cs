...
namespace UserModule_EPSON_POWERLITE_PRO_G6650WU_PROCESSOR_V1_0
{
    public class UserModuleClass_EPSON_POWERLITE_PRO_G6650WU_PROCESSOR_V1_0 : SplusObject
    {
    ...
    public UserModuleClass_EPSON_POWERLITE_PRO_G6650WU_PROCESSOR_V1_0 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
