...
namespace Crestron.RAD.Common.Enums;
    ...
    static class SecuritySystemStateObjects // enum
    {
        ...
        static SIGNED_LONG_INTEGER AreaCount;
        static SIGNED_LONG_INTEGER ZoneCount;
        static SIGNED_LONG_INTEGER OutputCount;
        static SIGNED_LONG_INTEGER DeviceCount;
        static SIGNED_LONG_INTEGER DoorCount;
    };
