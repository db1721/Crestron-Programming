...
namespace UserModule_LI232SOURCEDRIVER
{
    public class UserModuleClass_LI232SOURCEDRIVER : SplusObject
    {
...
public override void LogosSplusInitialize()
{
    ...
    MONITORPRESS = new InOutArray<DigitalInput>( 7, this );
    for( uint i = 0; i < 7; i++ )
    {
    ...
    SOURCEPRESS = new InOutArray<DigitalInput>( 13, this );
    for( uint i = 0; i < 13; i++ )
    {
    ...
    SOURCEPRESSED = new InOutArray<DigitalOutput>( 13, this );
    for( uint i = 0; i < 13; i++ )
    {
    ...
    MONITORVAL = new InOutArray<AnalogOutput>( 7, this );
    for( uint i = 0; i < 7; i++ )
    {
    ...
    MONITORSOURCE = new InOutArray<StringOutput>( 7, this );
    for( uint i = 0; i < 7; i++ )
    {
    ...
    SOURCENAME = new InOutArray<StringParameter>( 13, this );
    for( uint i = 0; i < 13; i++ )
    {
...
public UserModuleClass_LI232SOURCEDRIVER ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
...
const uint SOURCEPRESS__DigitalInput__ = 10;
...
const uint MONITORSOURCE__AnalogSerialOutput__ = 8;
