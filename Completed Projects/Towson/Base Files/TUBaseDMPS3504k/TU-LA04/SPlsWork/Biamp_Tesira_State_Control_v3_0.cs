...
namespace UserModule_BIAMP_TESIRA_STATE_CONTROL_V3_0
{
    public class UserModuleClass_BIAMP_TESIRA_STATE_CONTROL_V3_0 : SplusObject
    {
        ...
        BiampTesiraLib3.StateComponent COMPONENT;
        ushort ISREADY = 0;
        public void ONINITIALIZECHANGE ( object __sender__ /*BiampTesiraLib3.StateComponent SENDER */, BiampTesiraLib3.UInt16EventArgs ARGS ) 
            { 
...
{
    COMPONENT  = new BiampTesiraLib3.StateComponent();
    
    
}

public UserModuleClass_BIAMP_TESIRA_STATE_CONTROL_V3_0 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
