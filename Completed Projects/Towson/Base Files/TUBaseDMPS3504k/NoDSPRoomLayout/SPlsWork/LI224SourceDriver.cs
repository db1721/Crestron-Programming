...
namespace UserModule_LI224SOURCEDRIVER
{
    public class UserModuleClass_LI224SOURCEDRIVER : SplusObject
    {
...
public override void LogosSplusInitialize()
{
    ...
    SOURCEPRESS = new InOutArray<DigitalInput>( 6, this );
    for( uint i = 0; i < 6; i++ )
    {
    ...
    SOURCEPRESSED = new InOutArray<DigitalOutput>( 7, this );
    for( uint i = 0; i < 7; i++ )
    {
    ...
    SOURCENAME = new InOutArray<StringParameter>( 7, this );
    for( uint i = 0; i < 7; i++ )
    {
...
public UserModuleClass_LI224SOURCEDRIVER ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
