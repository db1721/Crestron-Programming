...
namespace UserModule_ANALOG_TO_NUMBER
{
    public class UserModuleClass_ANALOG_TO_NUMBER : SplusObject
    {
    ...
    public UserModuleClass_ANALOG_TO_NUMBER ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
